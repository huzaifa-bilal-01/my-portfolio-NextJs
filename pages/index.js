            ...
            <div class="mx-auto max-w-screen-xl">
              ...
              <div class="sm:flex sm:items-center sm:justify-between">
                ...
                <div className={classes.social_links}>
                  <Link href="/"><FontAwesomeIcon icon={faFacebook} className='px-2 text-white hover:text-blue-700' /></Link>
                  <Link href=""><FontAwesomeIcon icon={faTwitter} className='px-2 text-white hover:text-blue-500' /></Link>
                  <Link href=""><FontAwesomeIcon icon={faInstagram} className='px-2 text-white hover:text-instaMagenta' /></Link>
                  <Link href=""><FontAwesomeIcon icon={faLinkedin} className='px-2 text-white hover:text-linkedinblue' /></Link>
                  <Link href=""><FontAwesomeIcon icon={faGithub} className='px-2 text-white hover:text-githubblack' /></Link>
                  <Link href=""><FontAwesomeIcon icon={faYoutube} className='px-2 text-white hover:text-red-600' /></Link>
                </div>
              </div>
            </div>
          </footer>
