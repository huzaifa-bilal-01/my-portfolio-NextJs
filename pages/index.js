          ...
          <section id='hero' class=" pt-5 max-[768px]:justify-center max-[768px]:text-center max-[768px]:pt-20" data-aos="zoom-in-up">
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
              <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <p class="max-w-2xl mt-2 mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">Welcome to my world of coding and creativity, where Next.js empowers me to bring imagination to life.</p>
              ...
              <div class="grid grid-cols-1 mt-12 text-center sm:mt-16 gap-x-20 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class={`rounded-lg overflow-hidden shadow-md ${darkMode ? 'bg-white' : ' bg-gray-800'}`} data-aos="fade-up">
                  ...
                  <div class="p-4 space-y-2">
                    ...
                    <a href="https://github.com/huzaifa-bilal-01/MERN-Project-VeteranApp" title=""
                      class={`text-white inline-flex items-center px-4 py-2 text-sm font-medium rounded-md ${darkMode ? 'bg-primary-700 hover:bg-primary-800' : 'bg-primary-600 hover:bg-primary-700'}   `}>
                      Go to Github
                      <svg aria-hidden="true" class="w-5 h-5 ml-2 -mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                        fill="currentColor">
                ...
                <div class={`rounded-lg overflow-hidden shadow-md ${darkMode ? 'bg-white' : ' bg-gray-800'}`} data-aos="fade-up">
                  ...
                  <div class="p-4 space-y-2">
                    ...
                    <a href="https://github.com/huzaifa-bilal-01/REST-API_BLOG-AGGREGATOR_GOLANG" title=""
                      class={`text-white inline-flex items-center px-4 py-2 text-sm font-medium rounded-md ${darkMode ? 'bg-primary-700 hover:bg-primary-800' : 'bg-primary-600 hover:bg-primary-700'}   `}>
                      Go to Github
                      <svg aria-hidden="true" class="w-5 h-5 ml-2 -mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                        fill="currentColor">
                ...
                <div class={`rounded-lg overflow-hidden shadow-md ${darkMode ? 'bg-white' : ' bg-gray-800'}`} data-aos="fade-up">
                  <Image src="/images/ctf.png" width={330} height={330} alt="vet" class="w-full h-44 object-cover" />
                  <div class="p-4 space-y-2">
                    <h3 class="text-xl font-medium text-slate-500">
                      CTF Challenger Platform
                    </h3>
                    <p class={`text-md font-normal ${darkMode ? 'text-gray-600' : 'text-gray-300'} `}>
                    Developed a Web platform used to host Capture The Flag competitions.
                    </p>
                    <a href="https://github.com/mehmoodharis74/Ctf-Challenger-Platform" title=""
                      class={`text-white inline-flex items-center px-4 py-2 text-sm font-medium rounded-md ${darkMode ? 'bg-primary-700 hover:bg-primary-800' : 'bg-primary-600 hover:bg-primary-700'}   `}>
                      Go to Github
                      <svg aria-hidden="true" class="w-5 h-5 ml-2 -mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                        fill="currentColor">
            ...
            <div class="mx-auto max-w-screen-xl">
              ...
              <div class="sm:flex sm:items-center sm:justify-between">
                ...
                <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                  ...
                  <a href="https://x.com/anime_gotit?t=OzSFvi9dcFFvdVjVVPBTTg&s=09" class={`text-gray-500 ${darkMode ? 'hover:text-gray-900' : 'hover:text-white'}  `}>
